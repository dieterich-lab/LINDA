...
#'@param pValThresh2 the list of options for the run. See defaultLpSolveCarnivalOptions(),
...
#'lambda1=10.
#'@param lambda2 the list of options for the run. See defaultLpSolveCarnivalOptions(),
#'defaultCplexCarnivalOptions, defaultCbcCarnivalOptions.
...
#'memory but are likely to yield more solutions. By default, intensity=0.
