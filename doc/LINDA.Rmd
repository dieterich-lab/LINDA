...
**exon_id:** a transcript ID.
**effect:** an inclusion level difference score normalized between 
...
**significance:** this is as significance value associated with the IncLevelDifference
